...
<style>
#mycarousel6 .jcarousel-item {
	width: 295px;
	margin: 0 1px;
	height: 327px;
}
#mycarousel7 .jcarousel-item {
	width: 295px;
	margin: 0 1px;
	height: 365px;
}
#mycarousel8 .jcarousel-item {
	width: 295px;
	margin: 0 1px;
	height: 345px;
}
...
<script type="text/javascript" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/js/tabs.js"></script>               
          <?php if (count($this->get_recent_product_categories) > 0) { ?>  
                    ...
                    <div class="related_product_list clearfix">
                        <div class="title_outer">
                            ...
                            <div class="slider_wrap">
                                    <ul <?php if (count($this->get_recent_product_categories) > 4) { ?> id="mycarousel6" class="jcarousel-skin-tango2" <?php } else { ?> <?php } ?>>                         
                                        <?php
                                        $i = 1;
                                        foreach ($this->get_recent_product_categories as $products) {
                                            $symbol = CURRENCY_SYMBOL;
                                            ?>
                                            <li <?php if (count($this->get_recent_product_categories) < 5) { ?> <?php if($i==4) { ?> class="margin_zero" <?php } ?> <?php } else { ?> <?php } ?>>
...
<a onclick="addToCompare('<?php echo $products->deal_id; ?>','','detail');" title="<?php echo $this->Lang['ADD_COMPARE']; ?>">&nbsp;</a>
            ...
            <?php }?>
            <?php if (count($this->get_recent_deals_categories) > 0) { ?>
            <div class="store_page_listing">
                <div class="product_list_inner">
                                                                                             
                        <?php if (($this->deal_setting)) { ?>
                            <?php $j=1; if (count($this->get_recent_deals_categories) > 0) { ?>
                    <div class="related_product_list clearfix"> 
                        <div class="title_outer">
                            ...
                            <?php } ?>                                                                        
                            <div class="slider_wrap">                                
                                    <ul  <?php if (count($this->get_recent_deals_categories) > 4) { ?> id="mycarousel7" class="jcarousel-skin-tango2" <?php } else { ?> <?php } ?>>
                                        <?php
                                        foreach ($this->get_recent_deals_categories as $deals_categories) {
                                            $symbol = CURRENCY_SYMBOL;
                                            ?>
                                            <li <?php if (count($this->get_recent_deals_categories) < 5) { ?> <?php if($j==4) { ?> class="margin_zero" <?php } ?> <?php } else { ?> <?php } ?>>
...
<?php } ?>
 ...
 <?php /* <p><?php echo $symbol . " " . $deals_categories->deal_price; ?></p> */ ?>
            ...
            <?php if (count($this->get_recent_auction_categories) > 0) { ?>    
            <div class="store_page_listing">
                <div class="product_list_inner">
                   
                        <?php if (($this->auction_setting)) { ?>
                            <?php $k=1; if (count($this->get_recent_auction_categories) > 0) { ?>
                    <div class="related_product_list clearfix"> 
                            <div class="title_outer">
                                ...
                                <?php } ?>                                                                            
                            <div class="slider_wrap">  
                                    <ul <?php if (count($this->get_recent_auction_categories) > 4) { ?> id="mycarousel8" class="jcarousel-skin-tango2" <?php } else { ?> <?php } ?>>
                                        <?php
                                        foreach ($this->get_auction_categories as $deals1) {
                                            $symbol = CURRENCY_SYMBOL;
                                            ?>			
                                            <li <?php if (count($this->get_recent_auction_categories) < 5) { ?> <?php if($k==4) { ?> class="margin_zero" <?php } ?> <?php } else { ?> <?php } ?>>
                                                <div class="store_product_list">
                                                    <div class="store_product_list_img">
                                                        <i class="wloader_img">&nbsp;</i>
